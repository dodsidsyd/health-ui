<template>
  ...
  >
    ...
    <FlexColDiv class="gap-20 mg-24y">
  ...
  <ButtonGroup class="is-fixed">
    <Button btn-type="secondary" element-type="button" aria-label="거절하기" class="lg btn-sticky" />
    <Button btn-type="primary" element-type="button" :aria-label="buttonAriaLabel" class="lg btn-sticky" />
  </ButtonGroup>
  <!-- 챌린지 참가하기 모달 -->
  <BottomModal
...
import { ref } from 'vue'
import RecruitmentTeamChallengeCard from '~/components/publishing/walkking/RecruitmentTeamChallengeCard.vue'
