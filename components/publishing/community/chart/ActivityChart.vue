...
const rawGraphData: GraphDataItem[] = [
  { height: '30%', date: '일', dateClass: 'today' },
  { height: '100%', date: '월', dateClass: 'holiday' },
  { height: '200%', date: '화', dateClass: '' },
  { height: '0', date: '수', dateClass: '' },
  { height: '30%', date: '목', dateClass: '' },
  { height: '30%', date: '금', dateClass: '' },
  { height: '30%', date: '토', dateClass: '' }
]
